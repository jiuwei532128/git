            ...
            success: function (data) {
                ...
                $.each(data, function(index, first) {
                    ...
                    $.each(first.list, function (index2, second) {
                        ...
                        c += "<p style='text-align: center;margin-top: 2px;'><a href='#' onclick=\"addTabs('" + second.title + "','" + second.url + "','" + second.iconcls + "')\" class='easyui-linkbutton' data-options=\"width:'220px'\" >" + second.title+"</a></p>";
                    })
